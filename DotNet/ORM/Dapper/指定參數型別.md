...
## 使用 DynamicParameters 並呼叫 Stored Procedure 時

要注意參數必須加上 @ 開頭

```csharp
var para = new DynamicParameters();
para.Add("@companyId", CompanyId, DbType.Guid);
para.Add("@validEffectiveDate", validEffectiveDate, DbType.Date);
para.Add("@deptIds", deptIds.AsTableValuedParameter("dbo.ut_UuidListWithSerial"));

dapper.Execute("dbo.usp_xxxxxx", para, CommandType.StoredProcedure, _timeout);
```
